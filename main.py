...
pygame.display.set_caption("Awesome Shooter Game") # назва гри

FIGHTER_STEP = 0.3
fighter_image = pygame.image.load('images/fighter.png') # загружаємо картинку
...
while game_is_running:
    ...
    screen.blit(fighter_image, (fighter_x, fighter_y))# ставимо одну поверхность на іншу
