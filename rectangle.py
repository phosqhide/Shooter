...
while True:
    for event in pygame.event.get(): # собития які приисходять в игре
        # print(event)
    ...
    screen.fill(fill_color) # заполняєм фон
    pygame.draw.rect(screen, rect_color, (rect_x, rect_y, rect_width, rect_height)) # для прямоугольника
    pygame.display.update() # приминим изменения
